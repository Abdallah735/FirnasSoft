...
// func (c *Client) packetGeneratorWorker() { // 65507-5  --> 65502
...
// 			c.pendingPackets[packetID] = PendingPacketsJob{
// 				Job:      Job{Addr: c.serverAddr, Packet: packet},
// 				LastSend: time.Now(),
// 			}
// 			if task.AckChan != nil {
...
// 	fmt.Printf("Metadata received: %c (%d chunks, %d bytes each)\n", c.fileName, c.totalChunks, c.chunkSize)
...
// SendFileToServer: send metadata then chunks (client -> server)
